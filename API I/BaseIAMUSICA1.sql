CREATE DATABASE MusicPlayerDBIA;
GO
USE MusicPlayerDBIA;
...
CREATE TABLE Canciones (
    ...
    Estado VARCHAR(50) DEFAULT 1, -- Estado: Disponible(1)  o Reproducida (0)
...
VALUES ('Phonk'), ('EDM'), ('Reggaetón'), ('Rock'), ('Otros');
...
VALUES ('Danca Love', 'C:\Users\Jostin\Music\MUSICA BD\PHONK\Dança Love - XdrianGM .mp3', '00:01:54', 1),
	   ...
	   ('Ayer y Hoy', 'C:\Users\Jostin\Music\MUSICA BD\Otro\Ayer y Hoy Julio Jaramillo.mp3', '00:02:58',  5),
	   ('Colapso', 'C:\Users\Jostin\Music\MUSICA BD\Otro\Kevin Kaarl - Colapso - Kevin Kaarl.mp3', '00:03:29',  5),
	   ('Me enamoré de alguien', 'C:\Users\Jostin\Music\MUSICA BD\Otro\Me enamoré de alguien que también se enamoró - 𝐴𝑛𝑎.mp3', '00:01:50',  5),
	   ('PROTECTION CHARM', 'C:\Users\Jostin\Music\MUSICA BD\Otro\Miguel Angeles - PROTECTION CHARM .mp3', '00:03:00',  5),
	   ('Nothings New', 'C:\Users\Jostin\Music\MUSICA BD\Otro\Nothings New __ Rio Romeo __ Adventure Time_ Fionna and Cak.mp3', '00:03:38',  5),
	   ('Tu Boda', 'C:\Users\Jostin\Music\MUSICA BD\Otro\Oscar Maydon, Fuerza Regida - Tu Boda (Letra).mp3', '00:03:45',  5),
	   ('Que Nadie Sepa Mi Sufrir', 'C:\Users\Jostin\Music\MUSICA BD\Otro\Que Nadie Sepa Mi Sufrir, Julio Jaramillo.mp3', '00:02:43',  5),
	   ('Lost and Found', 'C:\Users\Jostin\Music\MUSICA BD\Otro\XdrianGM - Lost and Found.mp3', '00:03:15',  5);
...
WHERE TABLE_NAME = 'AnalisisMusical';

-- Verificar si hay registros en la tabla
SELECT COUNT(*) AS TotalRegistros FROM AnalisisMusical;

-- Verificar las canciones disponibles
SELECT * FROM Canciones;